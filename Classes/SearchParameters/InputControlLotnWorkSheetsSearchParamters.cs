...
{
    public class InputControlLotnWorkSheetsSearchParamters : SessionIDSearchParameters
    {
        ...
        public InputControlLotnWorkSheetsSearchParamters()
        {
