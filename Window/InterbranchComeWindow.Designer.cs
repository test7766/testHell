...
{
    partial class InterbranchComeWindow
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.getPSSTo561BindingSource = new System.Windows.Forms.BindingSource(this.components);
            ...
            this.getPSSTo561TableAdapter = new WMSOffice.Data.InterbranchTableAdapters.GetPSSTo561TableAdapter();
            ...
            ((System.ComponentModel.ISupportInitialize)(this.getPSSTo561BindingSource)).BeginInit();
            ...
            this.gvLines.DataSource = this.getPSSTo561BindingSource;
            ...
            // 
            // getPSSTo561BindingSource
            // 
            this.getPSSTo561BindingSource.DataMember = "GetPSSTo561";
            this.getPSSTo561BindingSource.DataSource = this.interbranch;
            // 
            // interbranch
            // 
            ...
            this.miRefresh.Size = new System.Drawing.Size(128, 22);
            this.miRefresh.Text = "&Обновить";
            this.miRefresh.Click += new System.EventHandler(this.miRefresh_Click);
            // 
            // getPSSTo561TableAdapter
            // 
            this.getPSSTo561TableAdapter.ClearBeforeFill = true;
            // 
            ...
            this.Name = "InterbranchComeWindow";
            this.Text = "InterbranchComeWindow";
            this.Load += new System.EventHandler(this.InterbranchComeWindow_Load);
            ...
            ((System.ComponentModel.ISupportInitialize)(this.getPSSTo561BindingSource)).EndInit();
        ...
        private System.Windows.Forms.BindingSource getPSSTo561BindingSource;
        private WMSOffice.Data.Interbranch interbranch;
        private WMSOffice.Data.InterbranchTableAdapters.GetPSSTo561TableAdapter getPSSTo561TableAdapter;
